        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certifications_AspNetUsers_TraineeId",
                        column: x => x.TraineeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Certifications_CertificationTracks_CertificationTrackId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackCourses", x => new { x.CertificationTrackId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_TrackCourses_CertificationTracks_CertificationTrackId",
                        column: x => x.CertificationTrackId,
                        principalTable: "CertificationTracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackCourses_Courses_CourseId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Session_DateRange", "[EndDateTime] > [StartDateTime]");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScheduledSessions_Instructors_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Enrollments_ScheduledSessions_ScheduledSessionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, "Trainee", "TRAINEE" },
                    { "2", null, "Instructor", "INSTRUCTOR" },
                    { "3", null, "TrainingCoordinator", "TRAININGCOORDINATOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certifications_CertificationTrackId",
                table: "Certifications",
                column: "CertificationTrackId");

            migrationBuilder.CreateIndex(
                name: "IX_Certifications_TraineeId_CertificationTrackId",
                table: "Certifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_ScheduledSessionId",
                table: "Enrollments",
                column: "ScheduledSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_TraineeId_ScheduledSessionId",
                table: "Enrollments",
                columns: new[] { "TraineeId", "ScheduledSessionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledSessions_InstructorId_StartDateTime_EndDateTime",
                table: "ScheduledSessions",
                columns: new[] { "InstructorId", "StartDateTime", "EndDateTime" });

            migrationBuilder.CreateIndex(
                name: "IX_ScheduledSessions_RoomId_StartDateTime_EndDateTime",
                table: "ScheduledSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackCourses_CourseId1",
                table: "TrackCourses",
                column: "CourseId1");
        }
